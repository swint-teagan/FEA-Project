...
Quad mesh, symmetric loading	Beam under uniform load	Hand-calc cross-check
![Quad stress field](images/quad_stress_field.png)	![Beam bending](images/beam_bending.png)	![Hand calculation](images/handcalc_beam_verification.png)
Tech Stack
